function [tree] = C4_5_C(X,y,threshold,feature)
...
for i = 1:c_X
    ...
    for j = 1:l_D_label
        ...
        if l_D1_y ~= 0 
            ...
            HAD1 = -1 * (l_D1_y / r_X) * log(l_D1_y / r_X);
        end;
...
%递归调用
tree.left = C4_5_C(left_X,left_y,0,feature);
tree.right = C4_5_C(right_X,right_y,0,feature);